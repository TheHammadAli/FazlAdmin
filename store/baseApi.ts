...
export const baseApi = createApi({
  ...
  tagTypes: ["profile", "CATEGORIES", "ADMIN_USERS", "ADMIN_CATEGORIES", "ADMIN_SHOPS", "ADMIN_SERVICES", "ADMIN_PRODUCTS", "ADMIN_BOOKINGS", "ADMIN_BROADCASTS", "ADMIN_ACCOUNTS", "ADMIN_ACTIVITY_LOGS", "ADMIN_FEED", "ADMIN_MEMBERS", "ADMIN_TASKS", "ADMIN_ANNOUNCEMENTS"],
  endpoints: () => ({}),
});
