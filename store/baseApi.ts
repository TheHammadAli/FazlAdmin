...
export const baseApi = createApi({
  ...
  tagTypes: ["profile", "CATEGORIES", "ADMIN_USERS", "ADMIN_CATEGORIES", "ADMIN_SHOPS", "ADMIN_SERVICES", "ADMIN_PRODUCTS", "ADMIN_BOOKINGS", "ADMIN_BROADCASTS", "ADMIN_ACCOUNTS", "ADMIN_ACTIVITY_LOGS", "ADMIN_FEED", "ADMIN_MEMBERS", "ADMIN_TASKS", "ADMIN_ANNOUNCEMENTS", "ADMIN_SETTINGS", "ADMIN_WALLET_DASHBOARD", "ADMIN_USER_WALLETS", "ADMIN_MERCHANT_WALLETS", "ADMIN_WALLET_TRANSACTIONS", "ADMIN_WITHDRAWALS", "ADMIN_REFUNDS", "ADMIN_WALLET_AUDIT_LOG", "ADMIN_WALLET_SETTINGS", "ADMIN_MERCHANT_DEALS", "ADMIN_REVIEWS", "ADMIN_REPORTS", "MEMBER_TASKS", "MEMBER_TASK_STATS", "ADMIN_EMAIL_LOGS"],
  endpoints: () => ({}),
});
