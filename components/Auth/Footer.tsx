    ...
    <div className="w-full flex flex-col gap-2 justify-center items-center">
      ...
      {showLinks && (
        <div className="flex w-full max-w-full flex-wrap items-center justify-center gap-x-2 gap-y-1">
          <Link
            href="/contact-us"
            className="text-green-1 text-[12px] font-normal"
          >
            {placeholders["contact" as keyof typeof placeholders] ?? "Contact"}
          </Link>
          ...
          <Link
            ...
            className="text-green-1 text-[12px] font-normal"
          >
            {placeholders["terms_condition" as keyof typeof placeholders] ??
          ...
          <Link
            ...
            className="text-green-1 text-[12px] font-normal"
          >
            {placeholders["privacy_policy" as keyof typeof placeholders] ??
              "Privacy Policy"}
          </Link>
        </div>
      )}
