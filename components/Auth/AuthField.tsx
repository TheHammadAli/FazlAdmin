...
/**
 * Outlined, notched-label field — matches the app's outlined FormField/
 * PasswordField variant and the web app's own AuthField: a full border box
 * with the label sitting on top of it, "cutting" the border line via a
 * background that matches the page (white). Border/label color respond to
 * focus and error via focus-within/group-focus-within rather than JS state.
 */
function AuthField({
  label,
  error,
