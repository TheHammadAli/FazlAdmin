...
function SubmitTask() {
    ...
    // One big page: the submit form needs every submittable task and the table below
    // shows the submission history — both come from the same "my tasks" list.
    ...
    function handleResubmit(taskId: string) {
    ...
    return (
        <section>
            ...
            <div className="bg-white pb-10">
                <div ref={formRef} className="container mx-auto px-5 pt-6 lg:px-10">
                    <form
                    ...
                    >
                        ...
                        <button
                            ...
                            className="mt-6 inline-flex h-[40px] w-full cursor-pointer items-center justify-center gap-2 rounded-[8px] bg-green-1 text-[14px] font-medium text-white disabled:cursor-not-allowed disabled:opacity-60"
                        >
                            {isSubmitting ? (
